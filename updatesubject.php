                ...
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                        ...
                        <div class="art-layout-cell art-content">
							...
							<h3 style="text-align:center">Update Subject</h3>
...
if($_POST)
	{
		...
		$sql1 = "UPDATE subject SET name = '$newsubject' WHERE name = '$subject'";
		if(mysqli_query($link, $sql1)){
echo '<script type="text/javascript">

          window.onload = function () { alert("Subject updated successfully."); }
          ...
          window.onload = function () { alert("Subject updation unsuccessful."); }
