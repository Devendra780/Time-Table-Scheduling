                ...
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                        ...
                        <div class="art-layout-cell art-content">
							...
							<h3 style="text-align:center">Update Venue</h3>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
 New venue name:
  <input type="text" name="newvenue" id="newvenue" >
  New Capacity:
...
if($_POST)
	{		
		...
		$sql1 = "UPDATE venue SET name = '$newvenue' , capacity=$capacity  WHERE name = '$venue'";
		if(mysqli_query($link, $sql1)){
echo '<script type="text/javascript">

          window.onload = function () { alert("Venue updated successfully."); }
          ...
          window.onload = function () { alert("Venue updation unsuccessful."); }
