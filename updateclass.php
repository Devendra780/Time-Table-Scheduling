                ...
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                        ...
                        <div class="art-layout-cell art-content">
							...
							<h3 style="text-align:center">Update Class</h3>
...
if($_POST)
	{
		...
		$sql1 = "UPDATE class SET name = '$newclass' WHERE name = '$class'";
		if(mysqli_query($link, $sql1)){
echo '<script type="text/javascript">

          window.onload = function () { alert("Class updated successfully."); }
          ...
          window.onload = function () { alert("Class updation unsuccessful."); }
