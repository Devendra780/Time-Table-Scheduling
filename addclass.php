...
if($_POST)
	{
		$class=$_POST['class'];	
		$sql = "INSERT INTO class (id, name) VALUES ($id+1, '$class')";
		if(mysqli_query($link, $sql)){
echo '<script type="text/javascript">

          window.onload = function () { alert("Class inserted successfully."); }
          ...
          window.onload = function () { alert("Class inserted unsuccessful."); }
