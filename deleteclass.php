                ...
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                        ...
                        <div class="art-layout-cell art-content">
							...
							<h3 style="text-align:center">Delete  Class</h3>
							<div align="center">
...
if($_POST)
	{
		$class=$_POST['class'];	
		$sql = "DELETE from class where name='$class'";
		if(mysqli_query($link, $sql)){
echo '<script type="text/javascript">

          window.onload = function () { alert("Class deleted successfully."); }
          ...
          window.onload = function () { alert("Class deletion unsuccessful."); }
