                ...
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                        ...
                        <div class="art-layout-cell art-content">
							...
							<h3 style="text-align:center">Delete  Venue</h3>
							<div align="center">
...
if($_POST)
	{
		$venue=$_POST['venue'];	
		$sql = "DELETE from venue where name='$venue'";
		if(mysqli_query($link, $sql)){
echo '<script type="text/javascript">

          window.onload = function () { alert("Venue deleted successfully."); }
          ...
          window.onload = function () { alert("Venue deletion unsuccessful."); }
