...
if($_POST)
	{
		...
		$sql="select id,name from class where name='$class'";
		...
		$sql1 = "INSERT INTO subject (id, name,class_id) VALUES ($id+1, '$subject',$class_id)";
		if(mysqli_query($link, $sql1)){
echo '<script type="text/javascript">

          window.onload = function () { alert("Subject inserted successfully."); }
          ...
          window.onload = function () { alert("Subject inserted unsuccessful."); }
