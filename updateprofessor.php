...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
 New Professor name:
  <input type="text" name="newprofessor" id="newprofessor" >
...
if($_POST)
	{
		...
		$sql1 = "UPDATE professor SET name = '$newprofessor' WHERE name = '$professor'";
		if(mysqli_query($link, $sql1)){
echo '<script type="text/javascript">

          window.onload = function () { alert("Professor updated successfully."); }
          ...
          window.onload = function () { alert("Professor updation unsuccessful."); }
