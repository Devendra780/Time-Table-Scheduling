...
<div id="art-page-background-simple-gradient">
 ...
 <button type="button" onclick="parent.location='manage.php'">Manage Information</button>

 <button type="button" onclick="parent.location='blank.php'">Create Time table</button>
